...
// ES5
console.log('This is ' + firstName2 + ' ' + lastName + '. He was born in ' + yearOfBirth + '. Today, he is ' + calcAge(yearOfBirth) + ' years old.')
...
const n = `${firstName2} ${lastName}`
console.log(n.startsWith('j'))
console.log(n.endsWith('Sm'))
console.log(n.includes('oh'))
console.log(`${firstName2} `.repeat(5))
...
const b2 = document.querySelectorAll('.box')
